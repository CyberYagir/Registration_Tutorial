...
c.prototype=b.prototype;a.Z=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.mo=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
;var Kc;function F(a,b,c){var d=Kc;Kc=null;a||(a=d);d=this.constructor.uo;a||(a=d?[d]:[]);this.j=(d?0:-1)-(this.constructor.so||0);this.h=void 0;this.N=a;a:{d=this.N.length;a=d-1;if(d&&(d=this.N[a],Dc(d))){this.l=a-this.j;this.i=d;break a}void 0!==b&&-1<b?(this.l=Math.max(b,a+1-this.j),this.i=void 0):this.l=Number.MAX_VALUE}if(c)for(b=0;b<c.length;b++)if(a=c[b],a<this.l)a+=this.j,(d=this.N[a])?Array.isArray(d)&&Cc(d):this.N[a]=Lc;else{d=this.i||(this.i=this.N[this.l+this.j]={});var e=d[a];e?Array.isArray(e)&&
Cc(e):d[a]=Lc}}
...
l.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Bo;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Qa}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
;var ve={Tn:"WEB_DISPLAY_MODE_UNKNOWN",Pn:"WEB_DISPLAY_MODE_BROWSER",Rn:"WEB_DISPLAY_MODE_MINIMAL_UI",Sn:"WEB_DISPLAY_MODE_STANDALONE",Qn:"WEB_DISPLAY_MODE_FULLSCREEN"};function we(){this.data_=[];this.h=-1}
...
r(pg,F);var qg={qh:0,ah:1,hh:2,ih:4,nh:8,jh:16,kh:32,ph:64,oh:128,dh:256,fh:512,mh:1024,eh:2048,gh:4096,bh:8192,lh:16384};function rg(a){F.call(this,a)}
...
r(Qg,F);var Rg;Rg=new function(a,b,c,d){this.h=a;this.fieldName=b;this.isRepeated=d;this.i=Xc}(406606992,{qo:0},Qg,0);function Sg(){Qg.apply(this,arguments)}
...
function gj(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,Bb:a,xa:b,no:!!e,headers:{},postBodyFormat:"",postBody:""}}
...
function Nj(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||B("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.lo||B("AUTHORIZATION"))||(a?b="Bearer "+A("gapi.auth.getToken")().ko:b=Jd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=B("SESSION_INDEX",0),L("pageid_as_header_web")&&(d["X-Goog-PageId"]=B("DELEGATED_SESSION_ID")));return d}
...
0;else a:{a=mn();c=q(a.ia);for(d=c.next();!d.done;d=c.next())if(d=d.value,n.message&&n.message.match(d.vo)){a=d.weight;break a}a=q(a.ha);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.la(n)){a=c.weight;break a}a=1}n.sampleWeight=a;a=q(gn);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ra[n.name])for(e=q(c.Ra[n.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=n.message.match(f.regexp)){n.params["params.error.original"]=d[0];e=f.groups;f={};for(k=0;k<e.length;k++)f[e[k]]=d[k+1],n.params["params.error."+
...
function Dn(a){a=q(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.yo("ABORTED")}
...
return a.join("")}
;var Hn,In=y.ytLoggingDocDocumentNonce_;In||(In=Gn(),Va("ytLoggingDocDocumentNonce_",In));Hn=In;var Jn={mg:0,nd:1,vd:2,Nj:3,og:4,In:5,Dk:6,cm:7,El:8,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS"};function Kn(a){this.h=a}
...
wh:72773,xh:26970,yh:26971,zh:96805,Ah:17752,Bh:73233,Ch:109512,Dh:22256,Eh:14115,Fh:22696,Gh:89278,Hh:89277,Ih:109513,Jh:43278,Kh:43459,Lh:43464,Mh:89279,Nh:43717,Oh:55764,Ph:22255,Qh:89281,Rh:40963,Sh:43277,Th:43442,Uh:91824,Vh:120137,Wh:96367,Xh:36850,Yh:72694,Zh:37414,ai:36851,ci:124863,bi:121343,di:73491,fi:54473,gi:43375,hi:46674,ii:143815,ji:139095,ki:32473,li:72901,mi:72906,ni:50947,oi:50612,ri:50613,si:50942,ti:84938,vi:84943,wi:84939,xi:84941,yi:84944,zi:84940,Ai:84942,Bi:35585,Ci:51926,
Di:79983,Ei:63238,Fi:18921,Gi:63241,Hi:57893,Ii:41182,Ji:135732,Ki:33424,Li:22207,Mi:42993,Ni:36229,Oi:22206,Pi:22205,Qi:18993,Ri:19001,Si:18990,Ti:18991,Ui:18997,Vi:18725,Wi:19003,Xi:36874,Yi:44763,Zi:33427,aj:67793,bj:22182,cj:37091,dj:34650,ej:50617,fj:47261,gj:22287,hj:25144,ij:97917,jj:62397,kj:125598,lj:137935,mj:36961,nj:108035,oj:27426,pj:27857,qj:27846,rj:27854,sj:69692,tj:61411,uj:39299,vj:38696,wj:62520,xj:36382,yj:108701,zj:50663,Aj:36387,Bj:14908,Cj:37533,Dj:105443,Ej:61635,Fj:62274,
Gj:133818,Hj:65702,Ij:65703,Jj:65701,Kj:76256,Lj:37671,Mj:49953,Oj:36216,Pj:28237,Qj:39553,Rj:29222,Sj:26107,Tj:38050,Uj:26108,Wj:120745,Vj:26109,Xj:26110,Yj:66881,Zj:28236,ak:14586,bk:57929,ck:74723,dk:44098,ek:44099,hk:23528,ik:61699,fk:134104,gk:134103,jk:59149,kk:101951,lk:97346,mk:118051,nk:95102,pk:64882,qk:119505,rk:63595,sk:63349,tk:95101,uk:75240,vk:27039,wk:68823,xk:21537,yk:83464,zk:75707,Ak:83113,Bk:101952,Ck:101953,Ek:79610,Fk:125755,Gk:24402,Hk:24400,Ik:32925,Jk:57173,Kk:122502,Lk:138480,
Mk:64423,Nk:64424,Ok:33986,Pk:100828,Qk:129089,Rk:21409,Vk:135155,Wk:135156,Xk:135157,Yk:135158,Zk:135159,al:135160,bl:135161,dl:135162,fl:135163,il:135164,jl:135165,kl:135166,Sk:11070,Tk:11074,Uk:17880,ll:14001,nl:30709,ol:30707,pl:30711,ql:30710,rl:30708,ml:26984,sl:63648,ul:63649,vl:51879,wl:111059,xl:5754,yl:20445,Al:130975,zl:130976,Bl:110386,Cl:113746,Dl:66557,Fl:17310,Gl:28631,Hl:21589,Il:68012,Jl:60480,Kl:138664,Ll:141121,Ml:31571,Nl:141978,Ol:76980,Pl:41577,Ql:45469,Rl:38669,Sl:13768,Tl:13777,
Ul:141842,Vl:62985,Wl:4724,Xl:59369,Yl:43927,Zl:43928,am:12924,bm:100355,em:56219,fm:27669,gm:10337,dm:47896,hm:122629,jm:139723,im:139722,km:121258,lm:107598,mm:127991,nm:96639,om:107536,pm:130169,qm:96661,rm:96658,sm:116646,tm:121122,um:96660,vm:127738,wm:127083,xm:104443,ym:96659,zm:106442,Am:134840,Bm:63667,Cm:63668,Dm:63669,Em:130686,Fm:78314,Gm:55761,Hm:127098,Im:134841,Jm:96368,Km:67374,Lm:48992,Mm:49956,Nm:31961,Om:26388,Pm:23811,Qm:5E4,Rm:126250,Sm:96370,Tm:47355,Um:47356,Vm:37935,Wm:45521,
Xm:21760,Ym:83769,Zm:49977,an:49974,bn:93497,cn:93498,dn:34325,en:140759,fn:115803,gn:123707,hn:100081,jn:35309,kn:68314,ln:25602,mn:100339,nn:143516,pn:59018,qn:18248,rn:50625,sn:9729,tn:37168,un:37169,vn:21667,wn:16749,xn:18635,yn:39305,zn:18046,An:53969,Bn:8213,Cn:93926,Dn:102852,En:110099,Fn:22678,Gn:69076,Hn:137575,Jn:139224,Kn:100856,Ln:17736,Mn:3832,Nn:55759,On:64031,Un:93044,Vn:93045,Wn:34388,Xn:17657,Yn:17655,Zn:39579,ao:39578,bo:77448,co:8196,eo:11357,fo:69877,ho:8197,jo:82039};function Yn(){var a=rb(Zn),b;return Af(new tf(function(c,d){a.onSuccess=function(e){hi(e)?c(new $n(e)):d(new ao("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
yo.prototype.handleResponse=function(a){var b;a=null===(b=a.responseContext)||void 0===b?void 0:b.locationPlayabilityToken;void 0!==a&&(this.locationPlayabilityToken=a,this.i=void 0,"TVHTML5"===B("INNERTUBE_CLIENT_NAME")?(this.h=zo(this))&&this.h.set("yt-location-playability-token",a,15552E3):rj("YT_CL",JSON.stringify({to:a}),15552E3,xo,!0))};
...
function dq(a,b,c){var d,e,f,g,h,k,m,n,t,x,u,C,D,K,N,S,W,Qa,zb;return w(function(P){switch(P.h){case 1:P.s(2);break;case 3:if((m=P.i)&&!m.isExpired())return P.return(Promise.resolve(m.h()));case 2:if((n=null===(d=b.config)||void 0===d?void 0:d.zo)&&a.h.has(n)&&L("web_memoize_inflight_requests"))return P.return(a.h.get(n));if(null===(e=null===b||void 0===b?void 0:b.aa)||void 0===e?0:e.context)for(t=q([]),x=t.next();!x.done;x=t.next())u=x.value,u.xo(b.aa.context);if(null===(f=a.i)||void 0===f?0:f.l(b.input,
...
;function Iq(){var a;return w(function(b){if(1==b.h)return v(b,bq(),2);if(a=b.i)return a.errorMetadata?(zn(Error("Datasync IDs fetch responded with "+a.errorMetadata.code+": "+a.error)),b.return(void 0)):b.return(a.po);An(Error("Network request to get Datasync IDs failed."));return b.return(void 0)})}
...
L("teardown_lifecycle_skip_unload")||window.addEventListener("unload",function(c){b.transition("document_disposed",c);b.h=new Map})}
